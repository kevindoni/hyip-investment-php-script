    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item <?php echo e(menuActive(['admin.rankingsUser'])); ?>">
                    <a class="sidebar-link <?php echo e(menuActive(['admin.rankingsUser'])); ?>"
                       href="<?php echo e(route('admin.rankingsUser')); ?>" aria-expanded="false">
                        <i class="fas fa-transgender text-cyan"></i>
                        <span class="hide-menu"><?php echo app('translator')->get('User Rankings'); ?></span>
                    </a>
                </li>
                ...
                <?php if(adminAccessRoute(config('role.commission_setting.access.view'))): ?>
                    ...
                    <li class="sidebar-item <?php echo e(menuActive(['admin.referral-commission'])); ?>">
                        <a class="sidebar-link <?php echo e(menuActive(['admin.referral-commission'])); ?>"
                           href="<?php echo e(route('admin.referral-commission')); ?>" aria-expanded="false">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="<?php echo e(route('admin.ticket',['open'])); ?>"
                           aria-expanded="false">
                            ...
                            <span class="hide-menu text-success"><?php echo app('translator')->get('Open Ticket'); ?></span>
                        </a>
                    </li>
                ...
                <?php if(adminAccessRoute(array_merge(config('role.website_controls.access.view'), config('role.language_settings.access.view')))): ?>
                    ...
                    <?php if(adminAccessRoute(config('role.website_controls.access.view'))): ?>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.currency.exchange.api.config')); ?>"
                               aria-expanded="false">
...
<?php /**PATH D:\xammp\htdocs\hyip8\project\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>