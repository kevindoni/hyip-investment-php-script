                ...
                <div class="table-parent table-responsive">
                    <table class="table table-striped">
                        ...
                        @forelse($tickets as $key => $ticket)
                            <tr>
                                <td>
                                    <span class="font-weight-bold"> [{{ trans('Ticket#').$ticket->ticket }}] {{ $ticket->subject }}
                                    </span>
                                </td>
                                <td>
                                    @if($ticket->status == 0)
                                ...
                                <td class="d-flex justify-content-end ticket-show">
                                    <a href="{{ route('user.ticket.view', $ticket->ticket) }}"
                                       class="btn btn-sm eye-btn btn2" title="@lang('Details')" >
                                        <i class="fa fa-eye"></i>
                                    </a>
                                </td>
                            </tr>
