        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="list-group">
                        <li class="list-group-item list-group-item-primary bg-transparent lebelFont darkblue-text">@lang('Transactions') : <span class="trx"></span>
                        </li>
                        <li class="list-group-item list-group-item-primary bg-transparent lebelFont darkblue-text">@lang('Admin Feedback') : <span
                ...
                <div class="modal-footer">
                    <button
                        type="button"
                        class="gold-btn btn-custom-rounded w-25 p-2 text-white"
