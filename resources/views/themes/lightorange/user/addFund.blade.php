        ...
        <div class="container-fluid">
            <div aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">@lang('Add Fund')</a></li>
                </ol>
            </div>
        </div>
    </section>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content form-block">
                    ...
                    <div class="modal-footer border-top-0">
                        <button type="button" class="btn btn-primary base-btn checkCalc">@lang('Next')</button>
                    </div>
                ...
                success(data) {
                    ...
                    var htmlData = `
                     <ul class="list-group text-center">
                        ...
                        <li class="list-group-item bg-transparent">
                        <a href="${data.payment_url}" class="btn btn-primary base-btn text-white  btn-block addFund ">@lang('Pay Now')</a>
                        </li>
                        </ul>`;
