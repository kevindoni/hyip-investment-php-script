        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-6">
                <div class="card-area">
                    ...
                    <form class="login-form wow fadeInUp" action="{{route('user.smsVerify')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12 login-query mt-30 text-center">
                                <p class="text-center">@lang('Didn\'t get Code? Click to') <a href="{{route('user.resendCode')}}?type=mobile"  class="text-info"> @lang('Resend code')</a></p>
