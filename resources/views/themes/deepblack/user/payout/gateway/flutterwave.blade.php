                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group input-box search-currency-dropdown">
                                            ...
                                            <select id="from_wallet" name="transfer_name"
                                                    class="form-control form-select form-control-sm bank">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group input-box search-currency-dropdown">
                                                ...
                                                <select id="from_wallet" name="currency_code"
                                                        class="form-control form-select form-control-sm transfer-currency">
                                                    <option value="" disabled=""
...
@push('script')
    <script type="text/javascript">
        ...
        $(document).on("change", ".transfer-currency", function () {
            ...
            var output = null;
            $('#showInfo').html('');
            output = `<li class="list-group-item font-weight-bold list-text bg-transparent customborder">@lang('Exchange rate') :
                        <span
                            class="float-right text-danger">1 ${baseCurrency} = ${rate} ${currencyCode}</span>
                    </li>
                    <li class="list-group-item font-weight-bold list-text bg-transparent customborder">@lang('You will get:') :
                        <span
