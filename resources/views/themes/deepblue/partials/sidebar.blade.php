...
<a class="das-nav nav-item {{menuActive(['user.fund-history', 'user.fund-history.search'])}}"
...
<a class="das-nav nav-item {{menuActive(['user.transaction', 'user.transaction.search'])}}"
...
<a class="das-nav nav-item  {{menuActive(['user.payout.money','user.payout.preview'])}}"
...
<a class="das-nav nav-item  {{menuActive(['user.payout.history','payout.history.search'])}}"
   href="{{route('user.payout.history')}}">
    <div class="icon-wrapper">
        <div class="nav-icon">
...
<a class="das-nav nav-item {{menuActive(['user.referral.bonus', 'user.referral.bonus.search'])}}"
...
<a class="das-nav nav-item {{menuActive(['user.ticket.list', 'user.ticket.create', 'user.ticket.view'])}}"
