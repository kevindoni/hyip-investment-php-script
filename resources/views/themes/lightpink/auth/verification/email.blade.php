                ...
                <div class="col-lg-5 col-md-7">
                    <div class="login_signup_form p-4">
                        <div class="section_header text-center">
                            <h4 class="pt-30 pb-30">@lang('Email Verification')</h4>
                        </div>
                        <form action="{{ route('user.mailVerify') }}" method="post">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="code" class="form-control" value="{{old('code')}}" placeholder="@lang('Enter Your Email Verification Code')">
                            ...
                            <div class="pt-5 d-flex">
                                ...
                                <br>
                                <h6 class="ms-2"><a href="{{route('user.resendCode')}}?type=email">@lang('Resent Code')</a></h6>
                                @error('resend')
