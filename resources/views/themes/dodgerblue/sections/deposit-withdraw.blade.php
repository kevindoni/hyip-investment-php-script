        ...
        <div class="row">
            <div class="col-12">
                <div class="header-text text-center">
                    ...
                    <h2>Last Deposits & <span class="text-stroke">Withdrawals</span></h2>
                    <p class="mx-auto">
                            ...
                            <div class="table-parent table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Gateway">Mollie</td>
                                        <td data-label="Date">27 Apr, 2023 06:11 AM</td>
                                    </tr>
                                    <tr>
                                        <td data-label="Name">
                                          <span class="currency">
                                        ...
                                        <td data-label="Amount">$234</td>
                                        <td data-label="Gateway">RazorPay</td>
                                        <td data-label="Date">27 Apr, 2023 06:11 AM</td>
                                    </tr>
                                    <tr>
                                        <td data-label="Name">
                                        ...
                                        <td data-label="Amount">$56</td>
                                        <td data-label="Gateway">Monnify</td>
                                        <td data-label="Date">27 Apr, 2023 06:11 AM</td>
                                    </tr>
                                    <tr>
                                        <td data-label="Name">
                            ...
                            <div class="table-parent table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        <td data-label="Name">
                                          <span class="currency">
                                             <img src="{{ asset($themeTrue.'img/client/client-1.jpg') }}" alt="...">
                                             Amanda Harvey
                                          </span>
                                        </td>
                                        <td data-label="Amount">$500</td>
                                    ...
                                    <tr>
                                        <td data-label="Name">
                                          <span class="currency">
                                             <img src="{{ asset($themeTrue.'img/client/client-2.jpg') }}" alt="...">
                                             Haval Ismail
                                          </span>
                                        </td>
                                        <td data-label="Amount">$234</td>
                                    ...
                                    <tr>
                                        <td data-label="Name">
                                          <span class="currency">
                                             <img src="{{ asset($themeTrue.'img/client/client-4.jpg') }}" alt="...">
                                             Amanda Harvey
                                          </span>
                                        </td>
                                        <td data-label="Amount">$986</td>
