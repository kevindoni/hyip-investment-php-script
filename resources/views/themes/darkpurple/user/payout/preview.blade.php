                    ...
                    <div class="card text-center">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item font-weight-bold list-text bg-custom-primary  text-white">@lang('Request Amount')
                                :
                                <span
                                    class="float-right text-white">{{getAmount($withdraw->amount)}} {{@$basic->currency_symbol}}</span>
                            </li>
                            <li class="list-group-item font-weight-bold list-text bg-custom-primary text-white">@lang('Charge Amount')
                                :
                                <span
                                    class="float-right text-danger text-white">{{getAmount($withdraw->charge)}} {{@$basic->currency_symbol}}</span>
                            </li>
                            <li class="list-group-item font-weight-bold list-text bg-custom-primary text-white">@lang('Total Payable')
                                :
                                <span
                                    class="float-right text-danger text-white">{{getAmount($withdraw->net_amount)}} {{@$basic->currency_symbol}}</span>
                            </li>
