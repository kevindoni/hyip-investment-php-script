        ...
        <div class="main row">
            <div class="col-12">
                <div
                    ...
                    <h3 class="mb-0">@lang('Add Fund')</h3>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <form>
                                    ...
                                    <div class="box">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group mb-3 cutom__referal_input__group">
                                                <input type="text" class="form-control amount darkpurple__input__group__fixed" name="amount" @if($totalPayment != null) value="{{$totalPayment}}" readonly @endif>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-custom text-white addCreateListingRoute btn-custom-rounded checkCalc">@lang('Next')</button>
                        </div>
                    </form>
                </div>
            </div>
