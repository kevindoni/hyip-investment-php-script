                                ...
                                @if($payout->status == 1)
                                    <a href="{{route('admin.payout-confirm',$payout->id)}}"
                                       ...
                                       class="btn btn-success btn-sm confirmButton"><i
                                            class="far fa-check-circle"></i> @lang('Confirm')</a>
                                    <a href="{{route('admin.payout-cancel',$payout->id)}}"
                                       data-toggle="modal"
                                       data-target="#confirmModal"
                                       class="btn btn-danger btn-sm confirmButton"><i
                                            class="far fa-times-circle"></i> @lang('Reject')</a>
                                @endif
                                ...
                                <div class="col-md-6 border-right">
                                    <ul class="list-style-none">
                                        ...
                                        <li class="my-3 d-flex align-items-center">
                                            <span><i
                                                    class="icon-check mr-2 text-primary"></i> @lang('Sender name :')</span>
                                            ...
                                            <span><i class="icon-check mr-2 text-primary"></i> {{ __(snake2Title($key)) }} :
                                                ...
                                                <span>
                                                        ...
                                                        <img class="img-profile rounded-circle"
                                                             src="{{asset(config('location.withdrawLog.path').$value->fieldValue??$value->field_name) }}">
                                                    @else
                                                        @if($key == 'amount')
